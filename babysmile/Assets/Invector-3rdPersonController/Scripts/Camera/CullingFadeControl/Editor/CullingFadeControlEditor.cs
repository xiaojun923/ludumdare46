        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_fadeControl.fadeMeshRenderers != null && _fadeControl.fadeMeshRenderers.Count > 0)
            {
                for (int a = 0; a < _fadeControl.fadeMeshRenderers.Count; a++)
                {
                    ...
                    GUILayout.BeginVertical("Original Material", "window", GUILayout.ExpandHeight(false));
                    ...
                    GUILayout.BeginVertical("Optional Fade Material", "window", GUILayout.ExpandHeight(false));
